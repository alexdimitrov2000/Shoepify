...
namespace Shoepify.Data.Migrations
{
    ...
    [Migration("20230105164916_AddedShoeCategory")]
    partial class AddedShoeCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shoepify.Domain.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Shoepify.Domain.ShoeSize", b =>
                {
                    b.Property<int>("ShoeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shoepify.Domain.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Shoepify.Domain.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Shoepify.Domain.ShoeColor", b =>
                {
                    ...
                    b.HasOne("Shoepify.Domain.Shoe", "Shoe")
                        .WithMany("Colors")
            ...
            modelBuilder.Entity("Shoepify.Domain.ShoeSize", b =>
                {
                    ...
                    b.HasOne("Shoepify.Domain.Size", "Size")
                        .WithMany("Shoes")
